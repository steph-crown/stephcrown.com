...
const Credits = () => {
  const breadcrumbData = [
    ...
    { name: 'Credits', url: 'https://stephcrown.com/credits' },
  ]

  return (
    <>
      <SEO
        title='Design Credits - Stephen Emmanuel Portfolio | Steph Crown'
        description='Design inspiration and credits for Stephen Emmanuel (Steph Crown) portfolio website. Acknowledging design influences and image sources.'
        keywords='Stephen Emmanuel portfolio credits, Steph Crown design credits, portfolio design inspiration'
        canonicalUrl='https://stephcrown.com/credits'
        structuredData={BREADCRUMB_STRUCTURED_DATA(breadcrumbData)}
        noIndex={true}
      />
      <main role='main' aria-label='Credits page'>
